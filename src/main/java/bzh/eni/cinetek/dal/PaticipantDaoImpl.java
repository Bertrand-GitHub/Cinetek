...
@Repository
public class PaticipantDaoImpl{

    private List<Participant> participants;

    public PaticipantDaoImpl() {
        this.participants = initializeParticipants();
    }


    public List<Participant> selectParticipants() {
        return participants;
    }
    ...
    public void updateParticipant(Participant participant) {
        // Update participant implementation
    }

    public void deleteParticipant(Participant participant) {
        // Delete participant implementation
    }

    public Participant selectOneById(int participantId) {
        // Select participant by ID implementation
        return null;
    }
